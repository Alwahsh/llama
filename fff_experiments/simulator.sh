...
gen_lens=(16 64 128 512 2048)

# in_seq_lens=(1 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192)
in_seq_lens=(2 8 128 512)

warmup_iterations=10
measured_iterations=10

echo "batch_size,fff_depth,gen_len,in_seq_len,time_prefill,time_decode,prefill_time_rms_norm,prefill_time_attention,prefill_time_ffn,prefill_time_transformer_block,prefill_time_transformer,decode_time_rms_norm,decode_time_attention,decode_time_ffn,decode_time_transformer_block,decode_time_transformer" > $output_csv
                ...
                if ((gen_len - in_seq_len >= 2)); then
                    ...
                    for fff_depth in "${fff_depths[@]}"; do
                        ...
                        for ((k=0; k<$measured_iterations; k++)); do
                            ...
                            measured_prefill_time_rms_norm=$(cat prefill_time_rms_norm_$k.txt)
                            ...
                            measured_decode_time_rms_norm=$(cat decode_time_rms_norm_$k.txt)
                            ...
                            echo "-1" > prefill_time_rms_norm_$k.txt
                            ...
                            echo "-1" > decode_time_rms_norm_$k.txt
                            ...
                            echo "$batch_size,$fff_depth,$gen_len,$in_seq_len,$measured_time_prefill,$measured_time_decode,$measured_prefill_time_rms_norm,$measured_prefill_time_attention,$measured_prefill_time_ffn,$measured_prefill_time_transformer_block,$measured_prefill_time_transformer,$measured_decode_time_rms_norm,$measured_decode_time_attention,$measured_decode_time_ffn,$measured_decode_time_transformer_block,$measured_decode_time_transformer" >> $output_csv
                        done
                    done
                fi
            done
